...
And you might wonder, why are some points in the plot larger then others? Good quesiton. The **size indicates the danceability** - another feature of the Spotify API - of the song. A quick glance shows us that the sizes aren't that much different between the two trends. 
...
I've chosen the tracks *Lemonade* by Internet Money and *#WIPEITDOWN* by BMW KENNY. I picked these two songs as they had similar values for Spotify's features and are both archetypes as TikTok songs. The *Lemonade* track is associated with a Dance trend, whereas the *#WIPEITDOWN* is associated with Other trend. 
