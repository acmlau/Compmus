...
temp_10 <- corpus_features %>%
  ggplot(aes(x = tempo, y = c10, colour = playlist, size = energy)) +
  geom_point(alpha = 0.8) +
  scale_color_viridis_d() +
  labs(
    x = "tempo",
...
Excepted to have *Highest importance* plot to have **more distinction** between the two trends *Dance* and *Other*. For the *Lowest importance* plot excepted to have  **no distinction** between the two trends. 
