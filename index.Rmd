...
sharedCorpus <- SharedData$new(corpus)
filter <- filter_checkbox("trend", "Trend", sharedCorpus, group = ~trends)

emotion_plot <- ggplot(sharedCorpus, aes(x = valence, y = energy, shape = trends, size = danceability)) +
...
`r bscols(list(filter))`


So how "positive" and intense are our songs? We can gauge this by using the Valence and Energy values. 
